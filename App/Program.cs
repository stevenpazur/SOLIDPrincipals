...
namespace App
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var reminder1 = new Reminder("Reminder 1", new DateTime(2017, 3, 17, 4, 4, 1));
            ...
            var event4 = new Holiday("Event 3", new DateTime(2018, 1, 12, 5, 5, 0), defaultDuration);
            ...
            Console.WriteLine("-------------------\niCalendar Export:\n-------------------\n");
            List<CalendarItem> items = new() {event1, event2, todo1, reminder1, event3, event4};
